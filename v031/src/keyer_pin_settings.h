...
// Edited wiring change 22 Oct 2025
...
#define potentiometer_enable_pin 0  // if defined, the potentiometer will be enabled only when this pin is held low; set to 0 to ignore this pin
  ...
  #define command_mode_active_led 16
...
// Wired for, but not impelemented in Software - KJ Oct 2025
#define cw_decoder_pin 0                  // This is for use with external decoding hardware
#define cw_decoder_audio_input_pin A14    // This is for audio detection decoding using OPTION_CW_DECODER_GOERTZEL_AUDIO_DETECTOR; this must be an analog pin!
#define cw_decoder_indicator 17           // Output - goes HIGH when cw tone is detected by OPTION_CW_DECODER_GOERTZEL_AUDIO_DETECTOR
