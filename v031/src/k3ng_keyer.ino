/*
Compiled for Arduino MEga 2560 (Pro)  K Johansen 19 Oct 2025
                            Pin assignments changed 22 Oct 2025
...
#define CODE_VERSION "2024.03.20.2239 KJ 2025"
...
void initialize_display(){
     ...
     if (LCD_COLUMNS < 9) {
      ...
      #else
        lcd_center_print_timed("hi  /  VA3KFJ", 1, 4000);
